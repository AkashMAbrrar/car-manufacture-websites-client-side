...
const InfoDetails = () => {
    return (
        <div className="card card-side bg-base-100 shadow-xl mt-20 m-10">
            <figure><img className='w-2/3' src="https://previews.123rf.com/images/dezay/dezay1610/dezay161000012/68402787-carro-de-im%C3%A1genes-ensamblado-de-repuestos-de-autom%C3%B3viles.jpg" alt="Movie" /></figure>
